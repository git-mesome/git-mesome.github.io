---
title: "AI 아키텍처 조언을 검증하는 절차를 정착시킨 경험"
...
---
## 서비스 간 통신 경계 재정의 - 내부 gRPC 남용에서 화면 조합으로
...
- AI가 반복해서 확신 있게 낸 "지금처럼 내부 gRPC로 묶는 게 적합하다"는 아키텍처 결론을, 근거를 캐물어 검증한 결과 실제로는 근거 없는 합리화(환각)였음을 확인했습니다.ㄴ
...
- BFF 도입을 검토하며 설계를 반복해서 손보는 동안, AI에게 계속 방향을 물었습니다.
...
- 두분 모두 잘못된 구현이라고 지적했습니다 - 서비스 간 결합도가 이 정도로 높으면 차라리 모놀리식으로 가는 게 낫다는 평가였습니다.
